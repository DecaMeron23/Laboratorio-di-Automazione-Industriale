...
export WIN32_AS_PROJECT_PATH := "C:\Users\emili\OneDrive - unibg.it\UNI\Anno III\Automazione Industriale\GitHub\Laboratorio-di-Automazione-Industriale\Ladder"
export WIN32_AS_SYSTEM_PATH := "C:\Program Files\AS\System"
export WIN32_AS_VC_PATH := "C:\Program Files\AS412\AS\VC"
export WIN32_AS_TEMP_PATH := "C:\Users\emili\OneDrive - unibg.it\UNI\Anno III\Automazione Industriale\GitHub\Laboratorio-di-Automazione-Industriale\Ladder\Temp"
export WIN32_AS_BINARIES_PATH := "C:\Users\emili\OneDrive - unibg.it\UNI\Anno III\Automazione Industriale\GitHub\Laboratorio-di-Automazione-Industriale\Ladder\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Ladder.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Rebuild'   
